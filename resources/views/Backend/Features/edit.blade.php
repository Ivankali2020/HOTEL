                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('features.update',$feature->id) }}" method="post" >
                            @method('PUT') @csrf
                            <input type="text" name="feature" value="{{ old('feature',$feature->name) }}" class="form-control">
                            ...
                            @foreach($features as $g)
                                <tr>
                                    ...
                                    <td class="d-flex">
                                        ...
                                        <form id="deleteGenre" action="{{ route('features.destroy',$g->id) }}" method="post" class="mx-2  ">
                                            @csrf @method('DELETE')
                                        </form>
