<div class="form-group ">
    ...
    <div class=" d-flex ">
        ...
        <input type="text"
               ...
               value="{{ old('download_link',$movie->one_movie->download_link ?? '') }}"
               placeholder="url ">
        ...
        <input
            ...
            value="{{ old('rating',$movie->one_movie->rating ?? '') }}"
            placeholder="rating">
        ...
        <select class="form-select  w-25 mr-3 " name="quality"  aria-label="Default select example">
            ...
            <option {{ $movie->one_movie->quality == $key ? 'selected'  : ''}}  value="{{ $key }}" >{{ $q }}</option>
            @endforeach
